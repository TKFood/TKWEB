...
namespace TKWEB.Controllers
{
    public class QUESTIONNAIRESController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("ID,DATES,NO,NAME,QUESTION1,QUESTION2")] QUESTIONNAIRES qUESTIONNAIRES)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(Guid id, [Bind("ID,DATES,NO,NAME,QUESTION1,QUESTION2")] QUESTIONNAIRES qUESTIONNAIRES)
        {
